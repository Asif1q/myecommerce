...
import com.example.sparksupport.myecommerce.exception.CustomAccessDeniedHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers("/api/products").hasAnyAuthority("SCOPE_ADMIN", "SCOPE_USER")
                .requestMatchers("/api/products/{id}").hasAnyAuthority("SCOPE_ADMIN", "SCOPE_USER")
                .requestMatchers("/api/products/admin/**").hasAuthority("SCOPE_ADMIN")
                .requestMatchers("/api/sales/**").hasAuthority("SCOPE_ADMIN")
